...
/**
 * An implementation of org.apache.lucene.searchCallback.RangeFilter that
...
public class BoundaryBoxFilter extends Filter {
     ...
     * permitted in searchCallback results, and false for those that should
     * not.
     */
...
//        TermEnum enumerator =
//            (null == lowerTerm ? reader.terms(new Term(fieldName, "")) : reader.terms(new Term(fieldName, lowerTerm)));
         TermEnum enumerator =
            (null != lowerTerm
