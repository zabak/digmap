 ...
 *
 */
public class TestBm25WithOutQueryParser extends TestCase {
    ...
    public void testRange() throws IOException, InvalidGeoException {
        ...
        TestBm25WithOutQueryParser.ScoreDoc scoreDoc1 = new TestBm25WithOutQueryParser.ScoreDoc(score1,"1");
        TestBm25WithOutQueryParser.ScoreDoc scoreDoc2 = new TestBm25WithOutQueryParser.ScoreDoc(score2,"2");
        TestBm25WithOutQueryParser.ScoreDoc scoreDoc3 = new TestBm25WithOutQueryParser.ScoreDoc(score3,"3");
        ...
        Collections.sort(scoreDocs,new Comparator<ScoreDoc>()
                                    {
                                        public int compare(TestBm25WithOutQueryParser.ScoreDoc o1, TestBm25WithOutQueryParser.ScoreDoc o2) {
...
//            queryConfiguration.setProperty("bm25.k3","8d");
            ...
            LgteQuery lgteQuery = new LgteQuery("word1 word2",queryConfiguration);
