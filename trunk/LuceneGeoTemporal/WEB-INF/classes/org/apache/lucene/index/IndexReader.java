...
/** IndexReader is an abstract class, providing an interface for accessing an
 ...
 @author Doug Cutting
 @version $Id: IndexReader.java,v 1.2 2004/10/10 20:18:08 gilad Exp $
*/
public abstract class IndexReader {
   ...
   *  If unknown field or info not stored, returns 0
   *
   * @see Field#isTermVectorStored()
   */
  abstract public int getFieldLength(int docNumber, String field)
          throws IOException;

  /** Return the document length (total number of terms in all fields)
   *  If unknown doc or info not stored, returns 0
   *
   * @see Field#isTermVectorStored()
   */
  abstract public int getDocLength(int docNumber) throws IOException;
