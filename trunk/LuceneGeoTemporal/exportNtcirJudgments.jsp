...
//            out.print("#TOPIC$$"+entry.getKey().trim()+"$$TITLE:" + ((Map<String,String>)request.getSession().getAttribute("topics")).get(entry.getKey()).replace("\n", " ").trim() + "\n");
            out.print("#TOPIC$$"+entry.getKey().trim()+"$$DESC:" + ((Map<String,String>)request.getSession().getAttribute("topics")).get(entry.getKey()).replace("\n", " ").trim() + "\n");
            out.print("#TOPIC$$"+entry.getKey().trim()+"$$NARR:" + ((Map<String,String>)request.getSession().getAttribute("topicsDesc")).get(entry.getKey()).replace("\n", " ").trim() + "\n");
