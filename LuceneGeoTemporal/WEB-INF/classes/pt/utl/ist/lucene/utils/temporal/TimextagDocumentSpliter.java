...
public class TimextagDocumentSpliter
{
    ...
    private static Logger logger = Logger.getLogger(TimextagDocumentSpliter.class);
     ...
     * @param sgml with \n before each TAG END
     * @param timexesDoc document with timexes generated by ILPS TIMEXTAG using TIDES notation
     * @see "http://fofoca.mitre.org/annotation_guidelines/2005_timex2_standard_v1.1.pdf"
     */
    public TimextagDocumentSpliter(String sgml,  TimexesDocument timexesDoc)
    {
    ...
    public void init(String sgml,  TimexesDocument timexesdoc)
    {
        this.sgml = sgml;
        this.text = sgml.replaceAll("<[^>]+>","");
        sentences = SentenceSpliter.split(text);
        timexesDocument = timexesdoc;


        if(timexesDocument.getTimex2TimeExpressionsSets() != null && timexesDocument.getTimex2TimeExpressionsSets().size()>0)
        {
            Iterator<Timex2TimeExpression.Timex2TimeExpressionsSet> timexesIterator = timexesDocument.getTimex2TimeExpressionsSets().iterator();
    ...
    public List<Timex2TimeExpression.Timex2TimeExpressionsSet> getTimex2TimeExpressionsSets() {
        return timexesDocument.getTimex2TimeExpressionsSets();
    }
    ...
    public static void main(String[] args)
    {
        ...
        TimextagDocumentSpliter documentSpliter = new TimextagDocumentSpliter(doc,"<DOC generator=\"timexdoc.py\">\n" +
            ...
            System.out.println(documentSpliter);
