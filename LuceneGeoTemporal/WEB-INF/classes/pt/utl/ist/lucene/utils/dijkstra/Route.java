	...
	implements Cloneable
{
	...
	private ArrayList<DijkstraNode> cities = new ArrayList<DijkstraNode>();
	...
	public Route clone()
	{
		...
		newInstance.cities = (ArrayList<DijkstraNode>) cities.clone();
	 ...
	 */
	void addStop(DijkstraNode stop, int distance)
	{
		if (!cities.isEmpty())
		{
	 ...
	 * has no stops.
	 */
	public DijkstraNode getLastStop()
	{
		if (cities.isEmpty())
		{
			return null;
	 ...
	 */
	public boolean hasCity(DijkstraNode city)
	{
