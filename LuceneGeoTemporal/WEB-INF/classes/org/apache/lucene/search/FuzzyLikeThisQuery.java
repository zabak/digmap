...
public class FuzzyLikeThisQuery extends Query
{
    ...
    private void addTerms(IndexReader reader,FieldVals f) throws IOException
    {
        ...
        Term internSavingTemplateTerm = new Term(f.fieldName,null); //optimization to avoid constructing new Term() objects
    ...
    public Query rewrite(IndexReader reader) throws IOException
    {
        ...
        for (Iterator iter = variantQueries.values().iterator(); iter.hasNext();)
        {
            ...
            {
                BooleanQuery termVariants=new BooleanQuery(); //disable coord and IDF for these term variants
                for (Iterator iterator2 = variants.iterator(); iterator2.hasNext();)
                {
                    ...
                    termVariants.add(tq, false,false);          // add to query                    
                }
                bq.add(termVariants, false,false);          // add to query
            }
        }
