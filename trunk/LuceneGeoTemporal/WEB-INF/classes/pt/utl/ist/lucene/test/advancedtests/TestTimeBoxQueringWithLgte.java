...
/**
 *
 * The objective of this class s help you to use Lgte Box Time Queries in a very quick example
 *
 ...
 *
 */
public class TestTimeBoxQueringWithLgte extends TestCase
{
    ...
    public void testRange() throws IOException, InvalidGeoException
    {
        ...
        String query = "contents:(Jorge Bruno) starttime:2000 endtime:2008";
        ...
        try
        {
            ...
            //doc 0
            //Now 2005 will appear in first place because time centroide is in 2004
            Date time0 = lgteHits.doc(0).getTime();
            int year0 = Integer.parseInt(s.format(time0));
            assertTrue(year0 == 2005);
            assertEquals(lgteHits.doc(0).get("contents"),"Jorge Machado and Bruno Martins three years ago");


            //doc 1
            Date time1 = lgteHits.doc(1).getTime();
            int year1 = Integer.parseInt(s.format(time1));
            assertTrue(year1 == 2007);
            assertEquals(lgteHits.doc(1).get("contents"),"Jorge Machado and Bruno Martins last year");
