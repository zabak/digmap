 ...
 *
 */
public class TestBm25bWithFieldsTermQueries extends TestCase {
    ...
    */
    ...
    public void testRange() throws IOException, InvalidGeoException {
        ...
        TestBm25bWithFieldsTermQueries.ScoreDoc scoreDoc1 = new TestBm25bWithFieldsTermQueries.ScoreDoc(score1,"1");
        TestBm25bWithFieldsTermQueries.ScoreDoc scoreDoc2 = new TestBm25bWithFieldsTermQueries.ScoreDoc(score2,"2");
        TestBm25bWithFieldsTermQueries.ScoreDoc scoreDoc3 = new TestBm25bWithFieldsTermQueries.ScoreDoc(score3,"3");
        ...
        Collections.sort(scoreDocs,new Comparator<ScoreDoc>()
                                    {
                                        public int compare(TestBm25bWithFieldsTermQueries.ScoreDoc o1, TestBm25bWithFieldsTermQueries.ScoreDoc o2) {
        ...
        try
        {
            ...
            LgteQuery lgteQuery = LgteQueryParser.parseQuery("contents:word1^" + factorContents + " contents:word2^" + factorContents + " title:title1^" + factorTitle + " title:title5^" + factorTitle,searcher,queryConfiguration);
