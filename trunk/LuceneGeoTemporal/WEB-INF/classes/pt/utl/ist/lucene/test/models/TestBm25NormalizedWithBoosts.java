 ...
 *
 */
public class TestBm25NormalizedWithBoosts extends TestCase {
    ...
    public void testRange() throws IOException, InvalidGeoException {
        ...
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc1 = new TestBm25NormalizedWithBoosts.ScoreDoc(score1,"1");
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc2 = new TestBm25NormalizedWithBoosts.ScoreDoc(score2,"2");
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc3 = new TestBm25NormalizedWithBoosts.ScoreDoc(score3,"3");
        ...
        {
            public int compare(TestBm25NormalizedWithBoosts.ScoreDoc o1, TestBm25NormalizedWithBoosts.ScoreDoc o2) {
        ...
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc1_2 = new TestBm25NormalizedWithBoosts.ScoreDoc(score1_2,"1");
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc2_2 = new TestBm25NormalizedWithBoosts.ScoreDoc(score2_2,"2");
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc3_2 = new TestBm25NormalizedWithBoosts.ScoreDoc(score3_2,"3");
        List<TestBm25NormalizedWithBoosts.ScoreDoc> scoreDocs_2 = new ArrayList<TestBm25NormalizedWithBoosts.ScoreDoc>();
        scoreDocs_2.add(scoreDoc1_2);
        scoreDocs_2.add(scoreDoc2_2);
        scoreDocs_2.add(scoreDoc3_2);
        Collections.sort(scoreDocs_2,new Comparator<TestBm25NormalizedWithBoosts.ScoreDoc>()
        {
            public int compare(TestBm25NormalizedWithBoosts.ScoreDoc o1, TestBm25NormalizedWithBoosts.ScoreDoc o2) {
                if(o1.score < o2.score) return 1;
                else if(o1.score == o2.score) return 0;
        ...
        //now will sort results using a wrapper for a pair <score,docId>
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc1_t = new TestBm25NormalizedWithBoosts.ScoreDoc((score1/maxScoreContents)*0.3f + score1_2/maxScoreContents2*0.6f,"1");
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc2_t = new TestBm25NormalizedWithBoosts.ScoreDoc(score2/maxScoreContents*0.3f + score2_2/maxScoreContents2*0.6f,"2");
        TestBm25NormalizedWithBoosts.ScoreDoc scoreDoc3_t = new TestBm25NormalizedWithBoosts.ScoreDoc(score3/maxScoreContents*0.3f + score3_2/maxScoreContents2*0.6f,"3");
        List<TestBm25NormalizedWithBoosts.ScoreDoc> scoreDocsTotal = new ArrayList<TestBm25NormalizedWithBoosts.ScoreDoc>();
        scoreDocsTotal.add(scoreDoc1_t);
        scoreDocsTotal.add(scoreDoc2_t);
        scoreDocsTotal.add(scoreDoc3_t);
        Collections.sort(scoreDocsTotal,new Comparator<TestBm25NormalizedWithBoosts.ScoreDoc>()
        {
            public int compare(TestBm25NormalizedWithBoosts.ScoreDoc o1, TestBm25NormalizedWithBoosts.ScoreDoc o2) {
                if(o1.score < o2.score) return 1;
                else if(o1.score == o2.score) return 0;
        ...
        try
        {
            ...
            queryConfiguration.setProperty("model.field.boost.contents2","0.6f");
