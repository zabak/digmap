...
final class TermVectorsWriter {
  ...
  public static final String TVL_EXTENSION = ".tvl";
  private OutputStream tvx = null, tvd = null, tvf = null, tvl = null;
  ...
  public TermVectorsWriter(Directory directory, String segment,
    ...
    tvl = directory.createFile(segment + TVL_EXTENSION);
    tvl.writeInt(FORMAT_VERSION);
  ...
  private void writeField() throws IOException {
    ...
    currentDocLength += currentField.length;
    String lastTermText = "";
