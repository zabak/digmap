...
public class LgteQueryParser {
    ...
    private static LuceneVersion luceneVersion = new LuceneVersion();

    public static LgteQuery parseQuery(String query) throws IOException, ParseException
    {
        return parseQuery(query,new LgteAnalyzer());
    }
    ...
    {
        return parseQuery(query,Globals.LUCENE_DEFAULT_FIELD,new LgteAnalyzer(),lgteIndexSearcherWrapper,null, null);
    }
    ...
    {
        return parseQuery(query,Globals.LUCENE_DEFAULT_FIELD,new LgteAnalyzer(),lgteIndexSearcherWrapper,null, sort);
    }
    ...
    {
        return parseQuery(query,Globals.LUCENE_DEFAULT_FIELD,new LgteAnalyzer(),lgteIndexSearcherWrapper,queryConfiguration);
    }
    ...
    {
        return parseQuery(query,field,new LgteAnalyzer(),lgteIndexSearcherWrapper,queryConfiguration);
    }
    ...
    public static LgteQuery parseQuery(String query, String field, Analyzer analyzer, LgteIndexSearcherWrapper indexSearcherWrapper, QueryConfiguration queryConfiguration, LgteSort sort) throws ParseException, IOException
    {
        ...
        return new LgteQuery(returnQuery,queryParams);
    }
    ...
    public static Query lucQE(Query query, String queryStr, String field, Analyzer analyzer, LgteIndexSearcherWrapper indexSearcherWrapper, QueryParams queryParams, LgteSort sort) throws IOException, ParseException
    {
        ...
        {
            LgteQuery lgteQuery = new LgteQuery(query,queryParams);
        ...
        if(field != null) Defs.setFldText(field.toString());
        else Defs.setFldText(Globals.LUCENE_DEFAULT_FIELD);
    ...
    private static void initConfiguration(QueryConfiguration queryConfiguration)
    {
        ...
        if(properties.getProperty("QE.method") == null)
            properties.setProperty("QE.method",Globals.ConfigProperties.getProperty("QE.method"));

        if(properties.getProperty("QE.decay") == null)
            properties.setProperty("QE.decay",Globals.ConfigProperties.getProperty("QE.decay"));

        if(properties.getProperty("QE.doc.num") == null)
            properties.setProperty("QE.doc.num",Globals.ConfigProperties.getProperty("QE.doc.num"));

        if(properties.getProperty("QE.term.num") == null)
            properties.setProperty("QE.term.num",Globals.ConfigProperties.getProperty("QE.term.num"));

        if(properties.getProperty("rocchio.alpha") == null)
            properties.setProperty("rocchio.alpha",Globals.ConfigProperties.getProperty("rocchio.alpha"));

        if(properties.getProperty("rocchio.beta") == null)
            properties.setProperty("rocchio.beta",Globals.ConfigProperties.getProperty("rocchio.beta"));
    }
