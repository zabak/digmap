 ...
 * previous filter in the bitset to be used in the next part of the chain.
 * 
 * @author admin
 *
 */
...
//	public abstract BitSet bits(IndexReader reader, BitSet bits) throws CorruptIndexException, IOException, Exception;
    public abstract BitSet bits(IndexReader reader, BitSet bits) throws IOException, Exception;
}
