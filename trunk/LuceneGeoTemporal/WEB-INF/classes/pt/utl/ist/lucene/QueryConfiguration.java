...
public class QueryConfiguration
{
    ...
    public String getProperty(String key)
    {
        ...
        return Globals.ConfigProperties.getProperty(key);
    }
    ...
    public int getIntProperty(String key)
    {
        ...
        return new Integer(Globals.ConfigProperties.getProperty(key)).intValue();
    }
    ...
    public float getFloatProperty(String key)
    {
        ...
        return new Float(Globals.ConfigProperties.getProperty(key)).floatValue();
    }
    ...
    public double getDoubleProperty(String key)
    {
        ...
        return new Double(Globals.ConfigProperties.getProperty(key)).doubleValue();
    }
    ...
    public boolean getBooleanProperty(String key)
    {
        ...
        return new Boolean(Globals.ConfigProperties.getProperty(key)).booleanValue();
    }
    ...
    public Object getPlugin(String pluginStr)
    {
        ...
        String implName = Globals.ConfigProperties.getProperty(pluginStr);
        if (implName == null || implName.length() == 0) {
            throw new RuntimeException("implementation not specified for " + pluginStr + " in PluginFactory propeties.");
        }
        try {
