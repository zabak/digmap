...
public class SimpleDocumentBuilder extends AbstractDocumentBuilder {
    ...
    public Document createDocument(BufferedImage image, String identifier) {
        ...
        if (sc != null)
            doc.add(new Field(DocumentBuilder.FIELD_NAME_SCALABLECOLOR, sc, true,false,true));
        if (cl != null)
            doc.add(new Field(DocumentBuilder.FIELD_NAME_COLORLAYOUT, cl, true,false,true));
        if (eh != null)
            doc.add(new Field(DocumentBuilder.FIELD_NAME_EDGEHISTOGRAM, eh, true,false,true));
        if (identifier != null)
            doc.add(new Field(DocumentBuilder.FIELD_NAME_IDENTIFIER, identifier, true,true,false));
        return doc;
    }
}
