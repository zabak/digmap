...
<xsl:template name="unimarc2dc_qualified" xmlns:dcterms="http://purl.org/dc/terms/">
	...
	<xsl:for-each select="//bn:datafield[@tag='461']//bn:subfield[code='0']">
		<dcterms:isPartOf><xsl:text>urn:digmap.eu:KbrDigmap:</xsl:text><xsl:value-of select="."/></dcterms:isPartOf>
	</xsl:for-each>
</xsl:template>    
