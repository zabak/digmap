 ...
 *
 * @version $Id: MultiReader.java,v 1.2 2004/10/10 21:29:53 gilad Exp $
 */
public class MultiReader extends IndexReader {
  ...
  */
  ...
  public int getFieldLength(int docNumber, String field)
      ...
      return subReaders[i].getFieldLength(docNumber, field);
  }

  public int getDocLength(int docNumber) throws IOException {
      int i = readerIndex(docNumber);
      return subReaders[i].getDocLength(docNumber);
  }
