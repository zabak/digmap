...
/**
 *
 * The objective of this class s help you to use Lgte in a medium example using internal transparent query parser
 *
 ...
 *
 */
public class TestSpatialDistanceWithLgteQueryString extends TestCase
{
    ...
    public void testRange() throws IOException, InvalidGeoException, ParseException
    {
        ...
        LgteHits hits = searcher.search(query, sort);
