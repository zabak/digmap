...
/**
 *
 * The objective of this class is test score model with spatial and Text
 *
 ...
 *
 */
public class TestSpatialDistanceWithLgteModelFiltering extends TestCase
{
    ...
    public void testRange() throws IOException, InvalidGeoException, ParseException
    {
        ...
        try
        {
            ...
            System.out.println(lgteHits.score(0));
            System.out.println(lgteHits.score(1));
            System.out.println(lgteHits.score(2));
            ...
            if(Model.defaultModel == Model.VectorSpaceModel)
                ...
                assertTrue(lgteHits.score(1) >= 0.49 && lgteHits.score(1) < 0.5);
            ...
            if(Model.defaultModel == Model.VectorSpaceModel)
                ...
                assertTrue(lgteHits.score(2) >= 0.39 && lgteHits.score(2) < 0.4);
