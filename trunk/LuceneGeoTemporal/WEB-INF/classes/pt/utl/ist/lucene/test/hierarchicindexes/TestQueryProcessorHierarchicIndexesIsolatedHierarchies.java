 ...
 */
public class TestQueryProcessorHierarchicIndexesIsolatedHierarchies extends TestCase {
    ...
    public void testTimeFilter() throws IOException, DocumentException, ParseException {
        ...
        LgteIndexWriter writer = new LgteIndexWriter(path + "ContentsTimexes",true);
        ...
        writer = new LgteIndexWriter(path + "Contents",true);
        ...
        LgteIndexWriter writer2 = new LgteIndexWriter(path + "SentencesTimexes",true);
        ...
        writer2 = new LgteIndexWriter(path + "Sentences",true);
        sentence0 = new LgteDocumentWrapper();
        sentence0.indexText(Globals.DOCUMENT_ID_FIELD, "1_0");
        sentence0.indexText("doc_id", "1");
        sentence0.indexText("sentences","word1 word3");
        sentence1 = new LgteDocumentWrapper();
        sentence1.indexText(Globals.DOCUMENT_ID_FIELD, "1_1");
        sentence1.indexText("doc_id", "1");
        sentence1.indexText("sentences","word1 word2 word3");
        sentence2 = new LgteDocumentWrapper();
        sentence2.indexText(Globals.DOCUMENT_ID_FIELD, "2_1");
        sentence2.indexText("doc_id", "2");
        ...
        IndexReader readerTimexesContents = LgteIndexManager.openReader(path + "ContentsTimexes", Model.OkapiBM25Model);
        IndexReader readerTimexesSentences = LgteIndexManager.openReader(path + "SentencesTimexes",Model.OkapiBM25Model);
        ...
        readers.put(Config.S_HAS_TIMEXES,readerTimexesContents);
        readers.put(Config.S_HAS_TIMEXES + "_sentences",readerTimexesSentences);
        ...
        lgteIsolatedIndexReader.addTreeMapping(readerTimexesContents,readerTimexesSentences,readerContents,"doc_id");
