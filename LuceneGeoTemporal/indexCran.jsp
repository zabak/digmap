...
<p>try for example: <a href="indexCran.jsp?q=experimental investigation">experimental investigation</a></p>

<form action="indexCran.jsp" method="post">
...
<%
    ...
    <%
            try
            {
                LgteIndexSearcherWrapper searcher = new LgteIndexSearcherWrapper(Model.LanguageModel, Globals.INDEX_DIR + "/lm/version1/cran");
