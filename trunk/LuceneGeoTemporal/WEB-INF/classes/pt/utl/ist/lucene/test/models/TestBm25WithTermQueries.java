 ...
 *
 */
public class TestBm25WithTermQueries extends TestCase {
    ...
    public void testRange() throws IOException, InvalidGeoException {
        ...
        TestBm25WithTermQueries.ScoreDoc scoreDoc1 = new TestBm25WithTermQueries.ScoreDoc(score1,"1");
        TestBm25WithTermQueries.ScoreDoc scoreDoc2 = new TestBm25WithTermQueries.ScoreDoc(score2,"2");
        TestBm25WithTermQueries.ScoreDoc scoreDoc3 = new TestBm25WithTermQueries.ScoreDoc(score3,"3");
        ...
        Collections.sort(scoreDocs,new Comparator<ScoreDoc>()
                                    {
                                        public int compare(TestBm25WithTermQueries.ScoreDoc o1, TestBm25WithTermQueries.ScoreDoc o2) {
...
//            queryConfiguration.setProperty("bm25.k3","8d");
            ...
            LgteQuery lgteQuery = LgteQueryParser.parseQuery("contents:word1 contents:word2",searcher,queryConfiguration);
