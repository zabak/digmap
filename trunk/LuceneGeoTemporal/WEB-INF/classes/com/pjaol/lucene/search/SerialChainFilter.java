 ...
 * index reader to each of the filter in an ordered fashion.
 * 
...
public class SerialChainFilter extends Filter {
	...
	public static final int AND = 3;	// regular filter may be used first
	public static final int OR = 4;		// regular filter may be used first
	...
	/* (non-Javadoc)
	 * @see org.apache.lucene.searchCallback.Filter#bits(org.apache.lucene.index.IndexReader)
	 */
	@Override
