...
public class LgteIndexSearcherWrapper 
{
    ...
    Model defaultModel = Model.parse(Globals.ConfigProperties.getProperty("lucene.model"));
    LuceneVersion luceneVersion = new LuceneVersion();
    ...
    public LgteHits search(BooleanQuery query) throws java.io.IOException, ParseException {
        LgteQuery lgteQuery = LgteQueryParser.parseQuery(query.toString("text"),this); // TODO: check if this is correct
    ...
    private LgteHits searchAndFilter(LgteQuery lgteQuery, LgteSort sort) throws IOException
    {
        ...
        return new LgteHits(hits,filterOrchestrator.getTimeDistances(),filterOrchestrator.getSpaceDistances(),lgteQuery.getQueryParams(), sort);
    }
