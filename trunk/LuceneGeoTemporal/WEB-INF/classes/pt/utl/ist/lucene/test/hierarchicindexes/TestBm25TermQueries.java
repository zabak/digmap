 ...
 *
 */
public class TestBm25TermQueries extends TestCase {
    ...
    public void testRange() throws IOException, InvalidGeoException {
        ...
        TestBm25TermQueries.ScoreDoc scoreDocV1 = new TestBm25TermQueries.ScoreDoc(scoreV1,"1_1");
        TestBm25TermQueries.ScoreDoc scoreDocV2 = new TestBm25TermQueries.ScoreDoc(scoreV2,"1_2");
        TestBm25TermQueries.ScoreDoc scoreDocV3 = new TestBm25TermQueries.ScoreDoc(scoreV3,"1_3");
        TestBm25TermQueries.ScoreDoc scoreDocV5 = new TestBm25TermQueries.ScoreDoc(scoreV5,"2_2");
        ...
        {
            public int compare(TestBm25TermQueries.ScoreDoc o1, TestBm25TermQueries.ScoreDoc o2) {
        ...
        TestBm25TermQueries.ScoreDoc scoreDoc1 = new TestBm25TermQueries.ScoreDoc(score1,"1");
        TestBm25TermQueries.ScoreDoc scoreDoc2 = new TestBm25TermQueries.ScoreDoc(score2,"2");
        List<TestBm25TermQueries.ScoreDoc> scoreDocs = new ArrayList<TestBm25TermQueries.ScoreDoc>();
        scoreDocs.add(scoreDoc1);
        scoreDocs.add(scoreDoc2);
        Collections.sort(scoreDocs,new Comparator<TestBm25TermQueries.ScoreDoc>()
        {
            public int compare(TestBm25TermQueries.ScoreDoc o1, TestBm25TermQueries.ScoreDoc o2) {
                if(o1.score < o2.score) return 1;
                else if(o1.score == o2.score) return 0;
        ...
        try
        {
            ...
            queryConfiguration.setProperty("index.tree","true");
             ...
             lgteQuery = LgteQueryParser.parseQuery("contents:word1^0.3 contents:word2^0.3 contents:word3^0.3 sentences:word1^0.7 sentences:word2^0.7 sentences:word3^0.7",searcher,queryConfiguration);
